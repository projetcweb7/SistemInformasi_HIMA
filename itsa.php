  ...
  <section id="about" class="section">
    <div class="container">
      <div class="row">
        <div class="span12">
          <div class="heading">
            <img src="assets/img/dummies/itsa.jpg" height="100" width="100">
            <h3><span>ITSA</span></h3>
          </div>
          <div class="sub-heading">
            <p>
               Information Technology Student Association Politeknik Caltex Riau (ITSA PCR) merupakan suatu organisasi kemahasiswaan yang beranggotakan seluruh mahasiswa/i jurusan Teknik Informatika  Politeknik Caltex Riau, himpunan ini pertama kali berdiri pada tanggal 16 Februari 2008 setelah berpisah dari Himpunan Mahasiswa Komputer. </p><br>
            <p>  ITSA memiliki visi dan misi sebagai berikut : </p>
            <p><strong>VISI :</strong></p>
<p>
Mewujudkan Information Technology Student Association Politeknik Caltex Riau sebagai pusat kegiatan mahasiswa di Provinsi Riau.</p>
<p><strong>MISI :</strong></p>
<p>
Mengembangkan Information Technology Student Association Politeknik Caltex Riau dengan melakukan kerja sama dengan pihak dalam maupun pihak luar yang sifatnya tidak mengikat.
Memonitori perkembangan teknologi informasi dan mengembangkan secara benar.
Mempererat hubungan antar mahasiswa khususnya mahasiswa jurusan Teknik Informatika.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="span3">
          <img src="assets/img/dummies/Bgbil.jpg"  width="400px" height="400px" alt="" class="img-polaroid" />
          <div class="roles">
            <h4>Khalifah Abil Jannatul Fasah</h4>
            <h5><strong>Gubernur ITSA</strong></h5>
          </div>
        </div>
        <div class="span3">
          <img src="assets/img/dummies/bgbal5.jpg" height="400px" alt="" class="img-polaroid" />
          <div class="roles">
            <h4>Iqbal Alhuda</h4>
