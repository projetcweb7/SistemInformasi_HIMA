      ...
      <div class="row">
        <div class="span12">
          ...
          <div class="sub-heading">	 		
            ...
            <p>4. Mengembangkan Riset terapan yang terkait dengan bidang komputer dan Teknologi Informasi untuk melayani kebutuhan industri yang meliputi kebutuhan sumber daya manusia, konsultasi teknis dan penelitian.</p> <br/>

            <h1> Ini Yang baru ditambahkan </h1>
                    </div>
        </div>
      </div>
