...
<!--             <p> HIMIKA memiliki beragam kegiatan positif diantaranya adalah: </p>
      ...
      <div class="row">
        ...
        <div class="span3">
          <img src="assets/img/dummies/himatronG.jpg"  width="400px" height="400px" alt="" class="img-polaroid" />
          <div class="roles">
            <h4>Muhammad Dafa</h4>
            <h5><strong>Gubernur HIMATRON</strong></h5>
          </div>
        </div>
        <div class="span3">
          <img src="assets/img/dummies/himatronWG.jpg" height="400px" alt="" class="img-polaroid" />
          <div class="roles">
            <h4>Aryatama Nur Putra</h4>
            <h5><strong>Wakil Gubernur HIMATRON</strong></h5>
